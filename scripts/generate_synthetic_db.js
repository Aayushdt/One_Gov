...
async function generateDataset(totalCount = 10000) {
  ...
  writeStream.write(`-- ============================================================================\n`);
  writeStream.write(`-- OneGov Synthetic Population Dataset (${totalCount} Citizens across 22 Silos)\n`);
  writeStream.write(`-- ============================================================================\n\n`);
  writeStream.write(`BEGIN;\n\n`);

  console.log(`Starting generation of ${totalCount} citizens and 100,000+ departmental records...`);
  ...
  for (let i = 1; i <= totalCount; i++) {
    ...
    const stateName = randChoice(stateKeys);
  ...
  console.log(`\n🎉 Success: Generated synthetic database SQL dump: ${sqlFile}`);
}
