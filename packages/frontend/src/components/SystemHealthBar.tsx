  ...
  return (
    <span
      style={{
        ...
        height: 8,
        borderRadius: '50%',
        background: ok ? '#2B8A68' : '#C43A22',
        boxShadow: ok ? '0 0 0 2px rgba(43,138,104,0.25)' : '0 0 0 2px rgba(196,58,34,0.25)',
    ...
    <>
      ...
      <div
        style={{
          ...
          border: `1px solid ${overallOk ? 'rgba(43,138,104,0.4)' : 'rgba(196,58,34,0.4)'}`,
          borderRadius: 10,
